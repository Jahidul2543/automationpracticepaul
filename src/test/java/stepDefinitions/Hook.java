    ...
    public  void initializeTest() {
        ...
        if(browserName.equalsIgnoreCase("chrome")){
            ...
            if (getOsNameFromSystem.contains("Mac")) {
                System.setProperty("webdriver.chrome.driver", "../automationpracticepaul/driver/chromedriver");
            } else if (getOsNameFromSystem.contains("Windows")) {
                System.setProperty("webdriver.chrome.driver", "../automationpracticepaul/driver/chromedriver.exe");
            }
            ...
            if (getOsNameFromSystem.contains("Windows")) {
                System.setProperty("webdriver.gecko.driver", "../automationpracticepaul/driver/geckodriver");
               // driver = new FirefoxDriver(options);
            } else if (getOsNameFromSystem.contains("Mac")) {
                System.setProperty("webdriver.gecko.driver", "../automationpracticepaul/driver/geckodriver.exe");
              //  driver = new FirefoxDriver(options);
            }
